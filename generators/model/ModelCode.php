...
class ModelCode extends CCodeModel
{
	...
	public $abstractModelPath ='application.models.base';
	public $buildConcreteClass=true;
	...
	public function rules()
	{
		return array_merge(parent::rules(), array(
			array('tablePrefix, baseClass, tableName, modelClass, modelPath, connectionId, abstractModelPath', 'filter', 'filter'=>'trim'),
			array('connectionId, tableName, modelPath, baseClass, abstractModelPath', 'required'),
			...
			//array('abstractModelPath', 'validateAbstractModelPath', 'skipOnError'=>true),
			array('baseClass, modelClass', 'validateReservedWord', 'skipOnError'=>true),
			array('baseClass', 'validateBaseClass', 'skipOnError'=>true),
			array('connectionId, tablePrefix, modelPath, abstractModelPath, baseClass, buildRelations, buildConcreteClass', 'sticky'),
		));
	}
	...
	public function attributeLabels()
	{
		return array_merge(parent::attributeLabels(), array(
			...
			'abstractModelPath'=>'Abstract Model Path',
	...
	public function prepare()
	{
		...
		foreach($tables as $table)
		{
			...
			$params=array(
				...
				'abstractModelPath'=>$this->abstractModelPath
			);
			if($this->buildConcreteClass){
			...
			$this->files[]=new CCodeFile(
				Yii::getPathOfAlias($this->abstractModelPath).'/Base'.$className.'.php',
				$this->render($templatePath.'/abstract_model.php', $params)
			);
		}
	}
