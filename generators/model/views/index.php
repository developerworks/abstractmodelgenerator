...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row model-class">
		...
		<?php echo $form->textField($model,'modelClass', array('size'=>65, 'style'=>'width:auto;')); ?>
		<div class="tooltip">
	...
	<div class="row sticky">
		...
		<?php echo $form->textField($model,'baseClass',array('size'=>65, 'style'=>'width:auto;')); ?>
		<div class="tooltip">
	...
	<div class="row sticky">
		...
		<?php echo $form->textField($model,'modelPath', array('size'=>65, 'style'=>'width:auto;')); ?>
		<div class="tooltip">
	...
	<div class="row sticky">
		<?php echo $form->labelEx($model, 'abstractModelPath'); ?>
		<?php echo $form->textField($model, 'abstractModelPath', array('size' => 65, 'style'=>'width:auto;')); ?>
		<div class="tooltip">
			This refers to the directory that the new abstract model classes file should be generated under.
			It should be specified in the form of a path alias, for example, <code>application.models.base</code>.
			Don't forget to add this path alias in the import section of your application's configuration file.
		</div>
		<?php echo $form->error($model, 'abstractModelPath'); ?>
	</div>
	<div class="row">
	...
	<div class="row">
		<?php echo $form->labelEx($model, 'buildConcreteClass'); ?>
		<?php echo $form->checkBox($model, 'buildConcreteClass'); ?>
		<div class="tooltip">
			Whether the concrete model class should be generated for the model class.
		</div>
		<?php echo $form->error($model, 'buildConcreteClass'); ?>
	</div>
